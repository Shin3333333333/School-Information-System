...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2026 at 02:28 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_get_announcements_data` (IN `p_mode` INT, IN `p_user_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_get_calendar` (IN `U_ID` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_get_student_schedule` (IN `p_user_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_get_teacher_schedule` (IN `p_user_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_user_management` (IN `p_mode` INT, IN `p_json` JSON)   BEGIN
...
INSERT INTO `announcements` (`id`, `title`, `date_posted`, `description`, `section_id`, `subject_id`, `user_id`, `add_to_calendar`, `calendar_date`) VALUES
(13, 'Preliminary Exams', '2026-03-16', 'Upcoming exam on March 14-15', 0, 2, 14, 1, '2026-03-15'),
(14, 'Math Long Quiz', '2026-03-16', 'Nyark', 0, 1, 14, 1, '2026-03-21'),
(21, 'asdsad', '2026-03-13', 'asdasd', 0, 1, 14, 0, NULL),
(22, 'sdadasd', '2026-03-14', 'asdasd', 0, 1, 14, 0, NULL),
(23, 'asdasd', '2026-03-16', 'asasdasd', 0, 1, 18, 1, '2026-03-19');
...
(4, 3, 5, 'Tuesday', '12:00:00', '15:00:00', '103', 14, 2, '2026-03-16 16:16:30'),
(5, 3, 5, 'Monday', '08:00:00', '11:00:00', '104', 18, 2, '2026-03-16 16:36:48');
...
(1, 'To provide quality education that nurtures the holistic development of every learner.', 'A center of excellence producing God-fearing, globally competitive, and socially responsible citizens.', '[\"Integrity\",\"Excellence\",\"Service\",\"Compassion\",\"Respect\",\"Burat\"]', '2026-03-16 10:43:06');
...
('0wAAneyUhQN02TEZK2oa3BDSmhsnYIF9X053lUmi', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773793680),
('ChxdCdhzTuhvV8jo4JLag1aCbuS6Hz5zFlaAqwEM', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773800820);
...
(29, 'Baliong', 'John Conrad', 'Iliw-Iliw', '2026-03-10', 'Male', 'Single', 'asdasdasdasd', '22-3850-57', 'Junior High School', 'Subject Teacher', 'Information Technology', '2026-03-10', 'Temporary', '09063128626'),
(30, 'Osabel', 'Anthony', 'asda', '2026-03-17', 'Male', 'Single', 'dadasdasdas', '22-3850-58', 'Junior High School', 'Subject Teacher', 'Information Technology', '2026-03-17', 'Permanent', '09063128626');
...
(1, 'Admin', 'administrator@example.com', '2026-03-03 09:38:11', '$2y$12$ELmBz8jzzAT86DtBccEUXuCO/FtevfUktk3u9KRmx0OeKr/YAYPOq', 'Z8lh6xNm1r2QJ7FtbdbznDofTA8P554EPxyCRHPmXjJJ2dULzckhaka7EFXU', '2026-03-03 09:38:12', '2026-03-17 16:31:48', 0, 3, 'Active'),
...
(18, 'Anthony Osabel', 'anthony@gmail.com', '2026-03-16 16:35:22', '$2y$12$KHa43ybnSuvJ4FrH5do.COKvP/mx2VoR6Y53FG8U7bBZRFhQT973O', NULL, '2026-03-16 16:35:22', '2026-03-16 16:35:22', 30, 1, 'Active');
...
(3, 'Calip', 'Kristin Chine', 'adsad', '2026-03-13', 'Female', 'Single', 1, 0, 'adsadsad', 222222222222, 2147483647),
