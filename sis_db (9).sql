...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2026 at 06:12 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_get_data` (IN `MODE` INT, IN `U_ID` INT)   BEGIN
    ...
    THEN
        ...
        JOIN        section sc             ON ans.section_id     = sc.id
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_sql_actions` (IN `MODE` INT, IN `p_json` JSON)   BEGIN
    ...
    THEN
      ...
      -- MODE 2: Insert the announcement (once)
        ...
        -- MODE 3: Insert each section link
        IF MODE = 3 
        THEN
...
INSERT INTO `announcement_sections` (`id`, `announcement_id`, `section_id`) VALUES
(6, 13, 1),
(7, 13, 3),
(8, 13, 4),
(59, 14, 1),
...
('OAysnXugRsI4unW4SBWxL08yDci4jQNV6KQ0qXLB', 14, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '', 1773339129);
